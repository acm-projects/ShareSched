...
class UserModel {
  ...
  static Future<Schedule> fetchUserSchedule(String userDocID) async {
    ...
    try {
      ...
      DocumentSnapshot<Map<String,dynamic>> ScheduleSnapshot = await FirebaseFirestore.instance
          .collection('Schedules') // Your main schedules collection
          .doc(userDocID) // The document ID for the user's schedule
          .get();
      QuerySnapshot<Map<String,dynamic>> ClassesSnapshot = await ScheduleSnapshot.reference
          .collection('Classes')
          .get();
